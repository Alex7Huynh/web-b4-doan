<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="BaoCaoBaiVietViPham.aspx.cs" Inherits="DangTinRaoVat" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
    ...
    <div>                   
         <asp:CheckBox ID="ckbTenSai" runat="server" Text="Tên sai chuyên mục" 
             meta:resourcekey="ckbTenSaiResource1" />
    </div>
    <div>
         <asp:CheckBox ID="ckbTieuDeSai" runat="server" Text="Tiêu đề tin không dấu" 
             meta:resourcekey="ckbTieuDeSaiResource1" />
    </div> 
    <div>
         <asp:CheckBox ID="ckbSpam" runat="server" 
             Text="Spam/Làm mới tin/Đăng tin quá qui định" 
