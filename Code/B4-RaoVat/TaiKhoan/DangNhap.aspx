<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DangNhap.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="UserName"
                                        ErrorMessage="Tên người dùng yêu cầu." ToolTip="Tên người dùng yêu cầu." ValidationGroup="Login1">Tên người dùng.</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                ...
                                <td>
                                    ...
                                    <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="Password"
                                        ErrorMessage="Mật khẩu yêu cầu." ToolTip="Mật khẩu yêu cầu." ValidationGroup="Login1">Mật khẩu người dùng.</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
    ...
    &nbsp;
    <asp:LinkButton ID="lbntDangKi" runat="server"  PostBackUrl="~/TaiKhoan/DangKi.aspx"> Đăng Kí</asp:LinkButton>
    &nbsp;
    <asp:LinkButton ID="lbntQuenMatKhau" runat="server" PostBackUrl="~/TaiKhoan/QuenMatKhau.aspx"> Quên Mật Khẩu</asp:LinkButton>
</asp:Content>
