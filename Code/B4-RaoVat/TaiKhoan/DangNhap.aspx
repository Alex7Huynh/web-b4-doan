<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="DangNhap.aspx.cs" Inherits="Default2" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="Server">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:CheckBox ID="RememberMe" runat="server" 
                                        Text="Nhớ đăng nhập lần sau của tôi" meta:resourcekey="RememberMeResource1" />
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td align="right" colspan="2">
                                    <asp:Button ID="LoginButton" runat="server" BackColor="#FFFBFF" BorderColor="#CCCCCC"
                                        ...
                                        Font-Size="0.8em" ForeColor="#284775" Text="Đăng Nhập" 
    ...
    <asp:Label ID="lblUserName" runat="server" Text="Tên UserName" 
        meta:resourcekey="lblUserNameResource1"></asp:Label>
    &nbsp;
    <asp:LinkButton ID="lbntDangXuat" runat="server" 
        meta:resourcekey="lbntDangXuatResource1">Đăng Xuất</asp:LinkButton>
    &nbsp;
