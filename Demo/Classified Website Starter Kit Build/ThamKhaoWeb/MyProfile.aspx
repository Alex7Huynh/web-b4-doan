		...
		<div id="col_main_right">
			...
			<div class="content_right">
				<fieldset>
					...
					<asp:RequiredFieldValidator runat="server" ControlToValidate="FirstNameTextBox" ValidationGroup="ChangeProfile"
					...
					<asp:CustomValidator ID="FirstNameRequiredFormat" runat="server" ValidationGroup="CreateUserWizardControl"
						ControlToValidate="FirstNameTextBox" ErrorMessage="First name is required and must be less than 40 characters long and contain apostrophes, spaces, or periods."
					...
					<asp:RequiredFieldValidator runat="server" ControlToValidate="LastNameTextBox" ValidationGroup="ChangeProfile"
					...
					<asp:CustomValidator ID="LastNameRequiredFormat" runat="server" ValidationGroup="CreateUserWizardControl"
						ControlToValidate="LastNameTextBox" ErrorMessage="Last name is required and must be less than 40 characters long and contain apostrophes, spaces, or periods."
					...
					<asp:RequiredFieldValidator runat="server" ControlToValidate="EmailTextBox" ValidationGroup="ChangeProfile"
						ErrorMessage="Email is required." ToolTip="Email is required." ID="EmailRequired"
						Display="Dynamic">
					</asp:RequiredFieldValidator>
					<asp:RegularExpressionValidator runat="server" ID="EmailRequiredFormat" ControlToValidate="EmailTextBox"
						ValidationGroup="ChangeProfile" ValidationExpression="^([0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*@([0-9a-zA-Z][-\w]*[0-9a-zA-Z]\.)+[a-zA-Z]{2,9})$"
					...
					<asp:ChangePassword ID="ChangePasswordControl" runat="server" ContinueButtonText="Return to My Ads"
						ContinueButtonType="Link" ContinueDestinationPageUrl="~/MyAds.aspx" OnChangedPassword="ChangePasswordControl_ChangedPassword"
