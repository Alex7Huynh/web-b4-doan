...
namespace DTO
{
    ...
    public class NguoiDungDTO
    {
        ...
        public NguoiDungDTO(NguoiDungDTO ndDTO)
        {
            _maNguoiDung = ndDTO.MaNguoiDung;
            _tenNguoiDung = ndDTO.TenNguoiDung;
            _matKhau = ndDTO.MatKhau;
            _email = ndDTO.Email;
            _dienThoai = ndDTO.DienThoai;
            _diaChi = ndDTO.DiaChi;
            _maKichHoatTaiKhoan = ndDTO.MaKichHoatTaiKhoan;
            _tinhTrangKichHoatTaiKhoan = ndDTO.TinhTrangKichHoatTaiKhoan;
            _thoiGianDangKy = ndDTO.ThoiGianDangKy;
            _thoiGianHetHan = ndDTO.ThoiGianHetHan;
            _loaiNguoiDung = ndDTO.LoaiNguoiDung;
            _deleted = ndDTO.Deleted;
        }
    }
}
