...
<div>
        ...
        <asp:View ID="BatDongSanView" runat="server">
            <table cellpadding="4" cellspacing="4">
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblHuong" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblLau" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:Label ID="lblLung" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <asp:View ID="TinTuyenDungView" runat="server">
            <table cellpadding="4" cellspacing="4">
                ...
                <tr>
                    ...
                    <td>
                        <asp:HyperLink ID="hypWebsite" runat="server" NavigateUrl=''></asp:HyperLink>
                    </td>
                </tr>
                <tr>
                    <td>
        ...
        <asp:View ID="HoSoTuyenDungView" runat="server">
            <table cellpadding="4" cellspacing="4">
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <asp:CheckBox ID="chkTinhTrangHonNhan" runat="server" Enabled="False" Text="Đã Kết Hôn" />
                    </td>
                </tr>
                <tr>
                    <td>
    ...
    <asp:HyperLink ID="hypXemThongTinLienHe" runat="server" Text="Xem Thông Tin Liên Hệ"
        NavigateUrl="../DanhMuc/XemThongTinLienHe.aspx?id=1" ForeColor="#990099"></asp:HyperLink>
</div>
