		...
		<div id="col_main_right">
			...
			<div class="content_right">
				<asp:GridView ID="ApprovalsGrid" runat="server" DataSourceID="ActivationsDataSource"
					...
					OnDataBound="ApprovalsGrid_DataBound" CellPadding="5" Width="100%" DataKeyNames="Id"
					BorderWidth="1">
					<EmptyDataTemplate>
				...
				<p>
					Use the
					<asp:HyperLink ID="AdAdminLink" runat="server" NavigateUrl="~/Admin/Ads.aspx">Ad Administration page</asp:HyperLink>
					to see <em>deleted</em> ads<br />
					(select "Marked as Deleted" from the Status list).</p>
				<asp:ObjectDataSource ID="ActivationsDataSource" runat="server" TypeName="AspNet.StarterKits.Classifieds.BusinessLogicLayer.AdsDB"
					SelectMethod="GetPendingAds" OnSelected="ActivationsDataSource_Selected"></asp:ObjectDataSource>
			</div>
		</div>
	</div>
</asp:Content>
