...
--7. DANHMUCCHINH
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Tất cả', N'images/DanhMucChinh/1.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Thời trang', N'images/DanhMucChinh/2.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Xây dựng - Nội thất – Ngoại thất', N'images/DanhMucChinh/3.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Điện thoại', N'images/DanhMucChinh/4.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Máy vi tính – Laptop', N'images/DanhMucChinh/5.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Điện tử - Kỹ thuật số', N'images/DanhMucChinh/6.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Ô tô', N'images/DanhMucChinh/7.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Xe máy- Xe đạp', N'images/DanhMucChinh/8.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Văn phòng phẩm', N'images/DanhMucChinh/9.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Ẩm thực', N'images/DanhMucChinh/10.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Đồ chơi - Mô hình', N'images/DanhMucChinh/11.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Đào tạo - Giáo dục', N'images/DanhMucChinh/12.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Sức Khỏe - Y tế', N'images/DanhMucChinh/13.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Dụng cụ thể thao', N'images/DanhMucChinh/14.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Du lịch', N'images/DanhMucChinh/15.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Cây cảnh -  Thú nuôi', N'images/DanhMucChinh/16.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Chứng khoán', N'images/DanhMucChinh/17.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Dịch vụ', N'images/DanhMucChinh/18.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Thủ công mỹ nghệ', N'images/DanhMucChinh/19.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Việc làm', N'images/DanhMucChinh/20.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Bất động sản', N'images/DanhMucChinh/21.jpg',0)
insert into DANHMUCCHINH (TenDanhMucChinh, Thumbnail, Deleted) values(N'Linh tinh', N'images/DanhMucChinh/22.jpg',0)
